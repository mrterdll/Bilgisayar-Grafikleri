...
window.onload = function init() {
	...
	// Description the letter Ö and L using triangles
	var vertices = [	vec2(-0.2,0.5),vec2(-0.4,0.5),vec2(-0.2,-0.5)
					  ,vec2(-0.2,-0.5),vec2(-0.4,0.5),vec2(-0.4,-0.5)
					  ,vec2(-0.4,0.5),vec2(-1.0,0.5),vec2(-1.0,0.3)
					  ,vec2(-0.4,0.5),vec2(-1.0,0.3),vec2(-0.4,0.3)
					  ...
					  ,vec2(0.2,0.5),vec2(0.4,0.5),vec2(0.2,-0.5)
					  ,vec2(0.4,0.5),vec2(0.2,-0.5),vec2(0.4,-0.5)
					  ,vec2(0.4,-0.3),vec2(1.0,-0.5),vec2(0.4,-0.5)
					  ,vec2(0.4,-0.3),vec2(1.0,-0.5),vec2(1.0,-0.3)	
					];
